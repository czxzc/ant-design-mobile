import SelectorMeta from '/Users/zc/Documents/project/ant-design-mobile/lowcode/selector/meta'
...
function fillRealVersion(
  meta,
  packageName = 'antd-mobile',
  version = '5.30.0',
  basicLibraryVersion = {
    '@alifd/next': '1.25.23',
    '@alifd/meet': '2.6.3',
  ...
  if (
    typeof basicLibraryVersion === 'object' &&
    basicLibraryVersion[npm.package]
  ) {
    meta.npm = {
      ...npm,
...
const componentMetas = [SelectorMeta]
const components = []
const npmInfo = {}
...
if (!execCompile) {
  window.AntdMobileMeta = { components, componentList }
}
